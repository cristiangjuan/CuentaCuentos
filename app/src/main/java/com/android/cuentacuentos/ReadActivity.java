...
import bitmaps.BitMapUtils;
import bitmaps.BitmapLoadStoragedPageTask;
import bitmaps.BitmapPageTask;
import bitmaps.BitmapSavePageTask;
import bitmaps.BitmapTextTask;
import customs.CustomPagerAdapter;
import customs.CustomScaleAnimationSubs;
import customs.CustomTransitionDrawable;
import customs.CustomView;
...
public abstract class ReadActivity extends FragmentActivity {
	...
	protected static int[][] cuadroTexto_001_01 = {
		...
		{R.drawable.vic_001_ct001_l001_w001, R.drawable.vic_001_ct001_l001_w002, R.drawable.vic_001_ct001_l001_w003, R.drawable.vic_001_ct001_l001_w004},
		{R.drawable.vic_001_ct001_l002_w001, R.drawable.vic_001_ct001_l002_w002, R.drawable.vic_001_ct001_l002_w003, R.drawable.vic_001_ct001_l002_w004},
		{R.drawable.vic_001_ct001_l003_w001, R.drawable.vic_001_ct001_l003_w002, R.drawable.vic_001_ct001_l003_w003, R.drawable.vic_001_ct001_l003_w004}
	};
	...
	protected static int[][] cuadroTexto_001_01_light = {
		...
		{R.drawable.vic_001_ct001_l001_w001_light, R.drawable.vic_001_ct001_l001_w002_light, R.drawable.vic_001_ct001_l001_w003_light, R.drawable.vic_001_ct001_l001_w004_light},
		{R.drawable.vic_001_ct001_l002_w001_light, R.drawable.vic_001_ct001_l002_w002_light, R.drawable.vic_001_ct001_l002_w003_light, R.drawable.vic_001_ct001_l002_w004_light},
		{R.drawable.vic_001_ct001_l003_w001_light, R.drawable.vic_001_ct001_l003_w002_light, R.drawable.vic_001_ct001_l003_w003_light, R.drawable.vic_001_ct001_l003_w004_light}
	};
	 ...
	 */
	protected static Dimension[] arrayPositionsCT_001 = {
		
		new Dimension(1606, 626)
	};
	...
	protected static Dimension[] arrayPositionsCT_002 = {
		
		new Dimension(203, 155), new Dimension(161, 275), new Dimension(133, 419), new Dimension(689, 925),
		new Dimension(131, 1615), new Dimension(1611, 113), new Dimension(2373, 669)
	};
	...
	protected static int [][][][] matrizCT = {
		...
		matrizCT_001, matrizCT_002
	};
	
	protected static int [][][][] matrizCT_light = {
		
		matrizCT_001_light, matrizCT_002_light
	};
	
	protected static Dimension [][] matrizPositionsCT = {
		
		arrayPositionsCT_001, arrayPositionsCT_002
	};
	
	protected static int [][][][] matrizTiemposCT = {
		
		arrayTimesCT_001, arrayTimesCT_002
	};
     ...
     * @param imageView
     */
    public void loadPageBitmap(int resId, CustomView imageView, Dimension frameRes, float scale) {
     ...
     */
    public void loadTextFrames (int resId, RelativeLayout frame, Dimension frameRes,
