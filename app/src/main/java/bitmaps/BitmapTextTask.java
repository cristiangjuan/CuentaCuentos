...
public class BitmapTextTask extends AsyncTask< Integer, Void, Integer > {
	...
	private Dimension[] mPositionsCT;
    ...
    public BitmapTextTask(Context context, Resources res, RelativeLayout imageFrame, Dimension frameRes,
    		ArrayList<CustomTransitionDrawable> arrayTransiciones, 
    		int[][][] matrizCT, int[][][] matrizCT_light, int[][][] matrizTiemposCT, Dimension[] positionsCT) {
    ...
    protected Integer doInBackground(Integer... params) {
        ...
        mScale = BitMapUtils.calculateScale(new Dimension(ReadActivity.frameWidth, ReadActivity.frameHeight),
                new Dimension(mBitmapRatio.getWidth(), mBitmapRatio.getHeight()));
    ...
    protected void onPostExecute(Integer result) {
        ...
        */
    	...
    	for (int i=0; i<mMatrizCT.length; i++) {
			...
			Dimension positionCuadroTexto = mPositionsCT[i];
			
			RelativeLayout.LayoutParams positionParams = new RelativeLayout.LayoutParams(
					LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
			positionParams.leftMargin = (int) (positionCuadroTexto.getWidth() * mScale / mRatio);
			positionParams.topMargin = (int) (positionCuadroTexto.getHeight() * mScale / mRatio);
